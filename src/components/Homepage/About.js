...
// import Image1 from '../../res/img/img1.jpg'
// import Image2 from '../../res/img/img2.jpg'

export default function About({about,mission,vision}) {
  if (!about && !mission && !vision)  return null // Don't render if nothing is visible
      ...
      {about && (
        <section id="about" className="py-5 bg-white text-center" data-aos="fade-right">
          <div className="container">
            <h2 className="text-success fw-bold mb-2">{about.title}</h2>
      ...
      {mission && (
        <div className="container-fluid py-5 bg-light">
          <div className="d-flex flex-column flex-md-row align-items-center justify-content-center">
            <div className="container">
              <h2 className="text-success fw-bold mb-2">{mission.title}</h2>
              <p className="lead">{mission.content}</p>
            </div>
            {mission.image_url && (
      ...
      {vision && (
        <div className="container-fluid py-5 bg-light">
          <div className="d-flex flex-column flex-md-row align-items-center justify-content-center">
            ...
            <div className="container">
              <h2 className="text-success fw-bold">{vision.title}</h2>
              <p className="lead">{vision.content}</p>
            </div>
          </div>
        </div>
      )}
...
// import React from 'react';
// import '../../AnimatedContentPage.css';
